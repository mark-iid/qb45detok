...
Only the `fc` row is something I have verified myself, across forty-two files.
...
Across the forty-two programs I have tested it on (my own code, a QuickBASIC
...
Every opcode in those programs is identified, and all 115 code sections decode
