...
Only the `fc` row is something I have verified myself, across fifty-two files.
...
Across the fifty-two programs I have tested it on (my own code, a QuickBASIC
...
Every opcode in those programs is identified, and all 246 code sections decode
