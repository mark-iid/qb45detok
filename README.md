...
Only the `fc` row is something I have verified myself, across fifty-six files.
...
Across the fifty-six programs I have tested it on (my own code, a QuickBASIC
...
Every opcode in those programs is identified, and all 251 code sections decode
