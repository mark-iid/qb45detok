...
BYTE_IDENTICAL = [
    ...
    "DRAWSCR1.BAS", "E10.BAS", "E11.BAS", "E12.BAS", "E13.BAS", "E9A.BAS",
    "E9B.BAS", "E9C.BAS", "EDGE.BAS", "EDGE2.BAS", "EDGE3.BAS",
    "EDGE4.BAS", "EDGE5.BAS", "EDGE6.BAS", "EDGE7.BAS", "EDGE8.BAS",
    "EXAMPLE1.BAS", "EXAMPLE2.BAS", "EXAMPLE3.BAS", "EXAMPLE4.BAS", "EXAMPLE5.BAS",
    "EXEC86.BAS", "FILEIO.BAS", "FILEOPS.BAS", "GRAPHIC2.BAS",
    "JOHNNY.BAS", "MAINMENU.BAS", "MATTMENU.BAS", "MISC.BAS", "MISC2.BAS",
    "NODOTS.BAS", "OBJSCAN.BAS", "OPENMODE.BAS", "PHYSICS.BAS",
    "PROJECT2.BAS", "QB8086.BAS", "RESERVED.BAS", "STARDEF.BAS",
    "SYSTEM.BAS", "TORUS.BAS", "TRAIL1.BAS", "TRAIL2.BAS", "TYPES.BAS",
    "TYPES2.BAS", "UNESS.BAS",
]
