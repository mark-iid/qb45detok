...
BYTE_IDENTICAL = [
    ...
    "FILEIO.BAS", "FILEOPS.BAS", "GRAPHIC2.BAS", "JOHNNY.BAS",
    "MAINMENU.BAS", "MATTMENU.BAS", "MISC.BAS", "MISC2.BAS", "NODOTS.BAS",
    "OBJSCAN.BAS", "OPENMODE.BAS", "PHYSICS.BAS", "PROJECT2.BAS",
    "RESERVED.BAS", "STARDEF.BAS", "SYSTEM.BAS", "TORUS.BAS",
