...
BYTE_IDENTICAL = [
    "CHAINRUN.BAS", "COLON1.BAS", "COLON2.BAS", "COVER2.BAS", "COVERAGE.BAS",
    "DECLARE.BAS", "DEFFN.BAS", "DEFTYPE.BAS", "DESCFILE.BAS", "DIRMAST.BAS",
    "DOTS.BAS", "DOTSUB.BAS", "DRAWSCR1.BAS", "FILEIO.BAS", "FILEOPS.BAS",
    "GRAPHIC2.BAS", "JOHNNY.BAS", "MAINMENU.BAS", "MATTMENU.BAS", "MISC.BAS",
    "MISC2.BAS", "NODOTS.BAS", "OBJSCAN.BAS", "OPENMODE.BAS", "PHYSICS.BAS",
    "PROJECT2.BAS", "RESERVED.BAS", "STARDEF.BAS", "SYSTEM.BAS", "TORUS.BAS",
    "TRAIL1.BAS", "TRAIL2.BAS", "TYPES.BAS", "TYPES2.BAS",
]
