...
_OPS = [
    ...
    _op(0x0089, "INPUT_PROMPT", ("u16", "u16"), 1, None, "stmt"),
    ...
    # Only one witness in the corpus, "OPTION BASE 1"; the base is not in an
    # operand, so it appears to be encoded in the opcode itself.
    ...
    _op(0x00D8, "PRESET", (), None, "PRESET", "stmt"),
